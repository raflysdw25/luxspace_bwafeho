...
// Mengatur Offset dari carousel item
function carouselCalculationOffset() {
...
// function untuk slide carousel item
...
if (carouselId) {
	...
	window.addEventListener('load', carouselCalculationOffset)
	window.addEventListener('resize', carouselCalculationOffset)
}
